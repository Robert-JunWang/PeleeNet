...
parser = argparse.ArgumentParser(description='PeleeNet Training')
parser.add_argument('data', metavar='DIR',
                    help='path to dataset')
parser.add_argument('-a', '--arch', metavar='ARCH', default='peleenet',
                    choices=model_names,
...
def validate(val_loader, model, criterion, args):
    ...
    with torch.no_grad():
        ...
        print('{time} * Acc@1 {top1.avg:.3f} Acc@5 {top5.avg:.3f}'
              .format(time=datetime.now(), top1=top1, top5=top5))
